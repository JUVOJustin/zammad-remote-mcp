...
| Import | What it is |
|---|---|
| `zammad-remote-mcp` | the runtime-agnostic core: Hono app, MCP server, 37 tools, Zammad client, search builder, OAuth proxy. Uses only WebCrypto, `fetch`, `TextEncoder` and `atob`/`btoa`. |
